  ...
  return (
    <button
      ...
      className={cn(
        ...
        isActive
          ? 'bg-card text-foreground border-2 border-primary border-b-card'
          : 'bg-muted text-muted-foreground hover:bg-secondary hover:text-secondary-foreground border-2 border-border border-b-transparent hover:border-b-transparent'
      )}
    >
